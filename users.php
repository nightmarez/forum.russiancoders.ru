				...
				<tbody>
					<?php
						...
						while (list($userid, $login) = $req->fetch(PDO::FETCH_NUM)) {
							...
							?>
								<tr>
									<td><img style="margin-right: 15px;" src="<?php echo getGravatarLink($userid, 25, $readydb); ?>" align="left"><?php if (isUserOnline($userid, $readydb)) { ?><div class="online-indicator"></div><?php } ?></td>

						...
						<div class="panel-heading">
							<div class="row">
								<div class="col-md-9">
									...
									<img src="<?php echo getGravatarLink($userid, 50, $readydb); ?>" alt="<?php echo $login; ?>" style="border-radius: 50%; border: 2px solid silver; padding: 2px; position: absolute; width: 50px; height: 50px; min-width: 50px; min-height: 50px; background-color: white; top: -16px; left: <?php if ($postnumber < 10) { echo '-14'; } else if ($postnumber < 100) { echo '-7'; } else if ($postnumber < 1000) { echo '1'; } else { echo '8'; } ?>px; margin-left: 50px;">
